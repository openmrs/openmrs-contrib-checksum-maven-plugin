...
try
{
  ...
  helper.assertFileContains( summaryFile, " *attached-artifacts.artifacts.shasum-summary-file-1.0.0-SNAPSHOT-src.tar.bz2" )
  helper.assertFileContains( summaryFile, " *attached-artifacts.artifacts.shasum-summary-file-1.0.0-SNAPSHOT-src.tar.gz" )
  helper.assertFileContains( summaryFile, " *attached-artifacts.artifacts.shasum-summary-file-1.0.0-SNAPSHOT-src.zip" )
  helper.assertFileContains( summaryFile, " *attached-artifacts.artifacts.shasum-summary-file-1.0.0-SNAPSHOT.jar" )
}
catch ( Exception e )
{
