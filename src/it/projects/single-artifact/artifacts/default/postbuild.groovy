...
try
{
  ...
  helper.assertFileIsNotEmpty( "target/single-artifact.artifacts.default-1.0.0-SNAPSHOT.jar.md5" )
  helper.assertFileIsNotEmpty( "target/single-artifact.artifacts.default-1.0.0-SNAPSHOT.jar.sha1" )
