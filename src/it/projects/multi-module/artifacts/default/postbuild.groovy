...
try
{
  ...
  helper.assertFileIsNotEmpty( "module1/target/multi-module.artifacts.default.module1-1.0.0-SNAPSHOT.jar.md5" )
  helper.assertFileIsNotEmpty( "module1/target/multi-module.artifacts.default.module1-1.0.0-SNAPSHOT.jar.sha1" )
  helper.assertFileIsNotEmpty( "module2/target/multi-module.artifacts.default.module2-1.0.0-SNAPSHOT.jar.md5" )
  helper.assertFileIsNotEmpty( "module2/target/multi-module.artifacts.default.module2-1.0.0-SNAPSHOT.jar.sha1" )
