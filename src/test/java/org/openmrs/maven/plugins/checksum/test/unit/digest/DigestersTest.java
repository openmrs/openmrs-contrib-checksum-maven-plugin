...
/**
 * Tests for each implementation of {@link FileDigester}.
 *
...
public class DigestersTest
{
     ...
     *
     * @return the list of tested {@link FileDigester} implementations.
     */
    @Parameterized.Parameters
    public static Collection<Object[]> getTestParameters()
    {
        List<Object[]> data = new ArrayList<>();
        for ( String algorithm : org.openmrs.maven.plugins.checksum.Constants.SUPPORTED_ALGORITHMS )
        {
     ...
     * @see FileDigester#calculate(java.io.File)
