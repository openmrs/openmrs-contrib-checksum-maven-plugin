 ...
 */
package org.openmrs.maven.plugins.checksum.execution;

import org.openmrs.maven.plugins.checksum.digest.DigesterException;
...
import org.openmrs.maven.plugins.checksum.execution.target.ExecutionTargetCloseException;
import org.openmrs.maven.plugins.checksum.execution.target.ExecutionTargetInitializationException;
...
/**
 * An implementation of {@link Execution} that throws exceptions when it
 * encounters errors.
 *
 * @author <a href="mailto:julien.nicoulaud@gmail.com">Julien Nicoulaud</a>
 * @see NeverFailExecution
 * @since 1.0
 * @version $Id: $Id
 */
