 ...
 * @see org.openmrs.maven.plugins.checksum.mojo
 * @since 1.0
 * @version $Id: $Id
 */
public interface Execution
{
    ...
    /**
     * Get the list of {@link ExecutionTarget} to be used by the
     * execution.
     *
    ...
    /**
     * Set the list of {@link ExecutionTarget} to be used by the
     * execution.
     *
    ...
    /**
     * Add a target to the list of {@link ExecutionTarget} to be
    ...
    /**
     * Remove a target from the list of {@link ExecutionTarget} to
